			...
			<div class="col-lg-3 col-md-6 col-12 footer_col">
				<div class="footer_widget">
				  ...
				  <div class="footer_social_icon">
					<a href="#" class="icons"><i class="fab fa-facebook-f"></i><span>Facebook</span></a>
					<a href="#" class="icons"><i class="fab fa-twitter"></i><span>Twitter</span></a>
					<a href="#" class="icons"><i class="fab fa-instagram"></i><span>instagram</span></a>
					<a href="#" class="icons"><i class="fab fa-linkedin"></i><span>linkedin</span></a>
					<a href="#" class="icons"><i class="fab fa-youtube"></i><span>youtube</span></a>
				  </div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12 col-12">
				<div class="copyright_text text-center">
					<p>Copyright 2020 @ Gigs All Rights Reserved. Developed by <a href="https://oxysquad.com/">oxysquad technologies</a></p>
				</div>
			</div>
		</div>
	</div>
